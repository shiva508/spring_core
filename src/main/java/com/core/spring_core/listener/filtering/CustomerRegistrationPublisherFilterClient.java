...
public class CustomerRegistrationPublisherFilterClient {
	...
	public static void main(String[] args) {
		AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext(
				CustomerRegistrationPublisherFilterClient.class);
		((CustomerRegistrationEventFilteringListener) context.getBean("eventFilteringListener"))
				.handleRegistration(new CustomerRegistrationEvent("Hellow Prends Who are yoo"));
	}
